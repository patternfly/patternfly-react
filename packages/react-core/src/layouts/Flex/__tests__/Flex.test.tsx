...
describe('Flex', () => {
  test('Simple flex with single item', () => {
    render(
      <Flex data-testid="flex-test-id">
        <FlexItem>Test</FlexItem>
      </Flex>
    );
    expect(screen.getByTestId('flex-test-id').outerHTML).toMatchSnapshot();
  });

  test('Nested flex', () => {
    const view = render(
      <Flex data-testid="outer-flex-test-id">
        <Flex>
          <FlexItem>Test</FlexItem>
        </Flex>
      </Flex>
    );
    expect(screen.getByTestId('outer-flex-test-id').outerHTML).toMatchSnapshot();
  });

  test('className is added to the root element', () => {
    const view = render(<Flex className="extra-class" data-testid="test-id" />);
