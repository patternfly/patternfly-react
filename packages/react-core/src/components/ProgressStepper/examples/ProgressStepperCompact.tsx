  ...
  return (
    <React.Fragment>
      <Checkbox
        ...
        onChange={(_event: React.FormEvent<HTMLInputElement>, checked: boolean) => setIsVertical(checked)}
      ...
      <Checkbox
        ...
        onChange={(_event: React.FormEvent<HTMLInputElement>, checked: boolean) => setIsCenterAligned(checked)}
