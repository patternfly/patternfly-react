...
export const TooltipPopper: React.FunctionComponent = ({ children, content }) => {
  ...
  return (
    <>
      ...
      <div className={css(styles.tooltip, styles.modifiers.top)} role="tooltip">
        <div className={css(styles.tooltipArrow)} ref={setArrowElement}></div>
        <div className={css(styles.tooltipContent)} ref={setPopperElement}>
          {content}
        </div>
      </div>
    </>
