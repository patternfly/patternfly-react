      ...
      <div>
        ...
        <div style={{ border: '1px solid' }}>
          <Checkbox
            ...
            onChange={(_event: React.FormEvent<HTMLInputElement>, checked: boolean) => setContentLeftAligned(checked)}
        ...
        <div style={{ border: '1px solid' }}>
          <Checkbox
            ...
            onChange={(_event: React.FormEvent<HTMLInputElement>, checked: boolean) => setEnableFlip(checked)}
        ...
        <div style={{ border: '1px solid' }}>
          <Checkbox
            ...
            isChecked={isVisible}
            onChange={(_event: React.FormEvent<HTMLInputElement>, checked: boolean) => setIsVisible(checked)}
