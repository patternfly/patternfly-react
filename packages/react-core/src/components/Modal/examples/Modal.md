...
class SimpleModal extends React.Component {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <Button variant="primary" onClick={this.handleModalToggle} ouiaId="Show Modal">
          Show Modal
        </Button>
        <Modal
          title="Simple modal header"
          ...
          onClose={this.handleModalToggle}
          actions={[
            <Button key="confirm" variant="primary" onClick={this.handleModalToggle} ouiaId="Confirm">
              Confirm
            </Button>,
            <Button key="cancel" variant="link" onClick={this.handleModalToggle} ouiaId="Cancel">
              Cancel
            </Button>
          ]}
          ouiaId="Simple modal"
