...
test('Renders without any modifier class when size props are not passed', () => {
  render(<Title headingLevel='h1'>Test</Title>);
  expect(screen.getByRole('heading')).toHaveClass('pf-c-title');
});

test('Renders with custom class name when className prop is passed', () => {
  render(<Title headingLevel='h1' className="test-class" >Test</Title>);
...
test('Renders with class name pf-m-4xl when "4xl" is passed as title size', () => {
  render(<Title headingLevel='h1' size='4xl'>Test</Title>);
