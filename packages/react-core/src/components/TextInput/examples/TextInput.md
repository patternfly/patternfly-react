...
SimpleTextInput = () => {
  ...
  return (
    <>
      ...
      />
      <Checkbox
        label="Use icon sprite"
        isChecked={isIconSprite}
        onChange={setIsIconSprite}
        aria-label="checkbox for icon sprite"
        id="isIconSpriteCheckbox"
      />
    </>
  );
};
