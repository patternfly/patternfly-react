  ...
  return (
    <>
      ...
      <Slider
        ...
        onChange={(_event: any, value: number) => handleChange(value, 'value1')}
        customSteps={steps}
      />
      <br />
      ...
      <Slider
        ...
        onChange={(_event: any, value: number) => handleChange(value, 'value2')}
        max={200}
        step={50}
        showTicks
      />
      ...
      <Slider
        ...
        onChange={(_event: any, value: number) => handleChange(value, 'value3')}
        min={-25}
        max={75}
        step={10}
        showTicks
      ...
      <Slider
        ...
        onChange={(_event: any, value: number) => handleChange(value, 'value4')}
        min={-25}
        max={75}
        step={10}
        showTicks
      ...
      <Slider
        ...
        onChange={(_event: any, value: number) => handleChange(value, 'value5')}
        min={-25}
        max={75}
        step={10}
      />
      ...
      <Slider
        ...
        onChange={(_event: any, value: number) => handleChange(value, 'value6')}
      />
      <br />
      ...
      <Slider
        ...
        onChange={(_event: any, value: number) => handleChange(value, 'value7')}
        min={12}
        max={86}
      />
      <br />
