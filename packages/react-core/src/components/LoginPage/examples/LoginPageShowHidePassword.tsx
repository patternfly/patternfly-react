    ...
    <React.Fragment>
      <LoginMainFooterLinksItem>
        <Button variant="plain" aria-label="Login with Google">
          <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512" className="pf-v6-svg">
      ...
      <LoginMainFooterLinksItem>
        <Button variant="plain" aria-label="Login with Github">
          <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" className="pf-v6-svg">
      ...
      <LoginMainFooterLinksItem>
        <Button variant="plain" aria-label="Login with Dropbox">
          <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 528 512" className="pf-v6-svg">
      ...
      <LoginMainFooterLinksItem>
        <Button variant="plain" aria-label="Login with Facebook">
          <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="pf-v6-svg">
      ...
      <LoginMainFooterLinksItem>
        <Button variant="plain" aria-label="Login with Gitlab">
          <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="pf-v6-svg">
