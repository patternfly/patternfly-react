...
export const ContentPlainList: React.FunctionComponent = () => (
  <>
    ...
    <Content component={ContentVariants.ul} isPlainList>
      ...
      <Content component={ContentVariants.li}>Aliquam nec felis in sapien venenatis viverra fermentum nec lectus.</Content>
    ...
    <Content component={ContentVariants.ol} isPlainList>
      ...
      <Content component={ContentVariants.li}> component={ContentVariants.li}Cras gravida arcu at diam gravida gravida.</Content>
