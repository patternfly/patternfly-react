...
describe('Wizard', () => {
  test('Wizard should match snapshot', () => {
    ...
    expect(screen.getByText('Wizard title').outerHTML).toMatchSnapshot();
  });
  ...
  test('bare wiz', () => {
    ...
    expect(screen.getByTestId('wizard-test-id').outerHTML).toMatchSnapshot();
  });
  ...
  test('wiz with title and navAriaLabel combination', () => {
    ...
    expect(nav.getAttribute('aria-labelledby')).toEqual('pf-wizard-title-4');
  });
  ...
  test('wiz with navAriaLabel and navAriaLabelledby and without title', () => {
    ...
    expect(nav).toBeInTheDocument();
    expect(nav.getAttribute('aria-labelledby')).toEqual('nav-aria-labelledby');
  });
  ...
  test('wiz with navAriaLabel and navAriaLabelledby and without title', () => {
    ...
    expect(main.getAttribute('aria-labelledby')).toEqual('main-aria-labelledby');
  });
