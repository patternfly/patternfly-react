...
export const ToolbarContainerQueryBasic: React.FunctionComponent = () => {
  ...
  const toggleGroupItems = (
    <Fragment>
      <ToolbarItem>
        <SearchInput
          aria-label="Container query example search input"
  ...
  return (
    <div className="ws-react-c-toolbar-resize-container">
      <Toolbar id="toolbar-container-query-basic" useContainerQuery>
