...
export interface PanelMainProps extends HTMLProps<HTMLDivElement> {
...
export const PanelMain: FunctionComponent<PanelMainProps> = ({
  className,
  children,
  maxHeight,
  ...props
  ...
  <div
    ...
    style={{ [cssMaxHeight.name]: maxHeight } as CSSProperties}
    {...props}
  >
    {children}
  </div>
