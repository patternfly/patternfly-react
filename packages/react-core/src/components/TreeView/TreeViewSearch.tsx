import { HTMLProps, ChangeEvent, FunctionComponent } from 'react';
...
export interface TreeViewSearchProps extends HTMLProps<HTMLInputElement> {
...
export const TreeViewSearch: FunctionComponent<TreeViewSearchProps> = ({
  className,
  onSearch,
  id,
  name,
