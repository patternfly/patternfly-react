...
module.exports = {
  ...
  getSingleContent: ({ tokenValue }) => `import React from 'react';
  import { SVGIcon } from '../SVGIcon';
  export var AccessibleIconIconConfig = {
  ...
  export var AccessibleIconIcon = function (props) {
      var newProps = Object.assign({ config: AccessibleIconIconConfig }, props);
