...
import { actions, columns, editableColumns, editableRows, rows } from "@patternfly/react-table/src/test-helpers/data-sets";
...
describe('Table', () => {
  ...
  // TODO: needs fix - dropdown bug causing error in test
