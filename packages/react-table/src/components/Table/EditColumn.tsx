  ...
  <React.Fragment>
    <div className={classNames(inlineStyles.inlineEditGroup, inlineStyles.modifiers.iconGroup, 'pf-m-action-group')}>
      <div className={classNames(inlineStyles.inlineEditAction)}>
        <Button
          ...
          {...props}
          onClick={(e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => onClick(e, 'save')}
          variant="plain"
        >
          <CheckIcon />
        </Button>
      ...
      <div className={classNames(inlineStyles.inlineEditAction)}>
        <Button
          ...
          {...props}
          onClick={(e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => onClick(e, 'cancel')}
          variant="plain"
        >
          <TimesIcon />
        </Button>
    ...
    <div className={classNames(inlineStyles.inlineEditAction, inlineStyles.modifiers.enableEditable)}>
      <Button
        ...
        {...props}
        onClick={(e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => onClick(e, 'edit')}
        variant="plain"
      >
        <PencilAltIcon />
      </Button>
