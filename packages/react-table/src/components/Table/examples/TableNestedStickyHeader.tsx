            ...
            <Tr key={connection.source.podName}>
              ...
              <Td dataLabel={columnNames.datetime}>
                <div>
                  ...
                  <span className={styles.color_200}>{new Date(connection.timestamp).toLocaleTimeString()}</span>
                </div>
              </Td>
              <Td dataLabel={columnNames.source}>
                <Stack>
                  ...
                  <StackItem>
                    <span className={styles.color_200}>({connection.source.port.protocol})</span>
                  </StackItem>
                </Stack>
              </Td>
              <Td dataLabel={columnNames.destination}>
                <Stack>
                  ...
                  <StackItem>
                    <span className={styles.color_200}>({connection.destination.port.protocol})</span>
                  </StackItem>
                </Stack>
              </Td>
