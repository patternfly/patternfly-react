describe('NumberInput Demo Test', () => {
  ...
  it('can have different unit positions', () => {
    cy.get('#numberInput1').children().first().should('have.class', 'pf-c-input-group');
    cy.get('#numberInput1').children().last().should('have.class', 'pf-c-number-input__unit');
    cy.get('#numberInput2').children().first().should('have.class', 'pf-c-number-input__unit');
    cy.get('#numberInput2').children().last().should('have.class', 'pf-c-input-group');
  });
