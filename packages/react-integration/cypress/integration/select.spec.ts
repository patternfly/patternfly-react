describe('Select Test', () => {
  ...
  it('Verify Select with Divider', () => {
    ...
    cy.get('#Miss > .pf-v6-c-select__menu-item').click();
    cy.get('#single-select-with-divider').contains('Miss').should('exist');

    cy.get('#single-select-with-divider').click();
    cy.get('#Mr > .pf-v6-c-select__menu-item').click();
  ...
  it.skip('Verify Description Select', () => {
    ...
    cy.get('.pf-v6-c-select__menu-footer').should('exist');
    cy.get('#Miss > .pf-v6-c-select__menu-item > .pf-v6-c-select__menu-item-description').click();
  ...
  it('Verify Typeahead Select', () => {
    ...
    find('button.pf-v6-c-select__toggle-button').click();
    find(
      '#Alabama > .pf-v6-c-select__menu-item > .pf-v6-c-select__menu-item-row > .pf-v6-c-select__menu-item-count'
    ).should('exist');
    find('li:nth-child(3) button').click();
  ...
  it('Verify isInputValuePersisted works', () => {
    ...
    cy.get('.pf-v6-c-title').eq(0).click();
    find('#typeahead-select-select-typeahead').should('have.value', '');
  ...
  xit('Verify Creatable Typeahead Select', () => {
    ...
    cy.get(':nth-child(5) > :nth-child(2) > .pf-v6-c-select > .pf-v6-c-select__toggle input').type('Al');
    cy.get('#Al-1').click();
    cy.get('#select-typeahead').should('have.value', 'Al');
    cy.get('#typeahead-select').click();
    cy.get('#Al-5').should('exist');
    cy.get('button.pf-v6-c-select__toggle-clear').click();
  });

  xit('Verify Typeahead Multi Select', () => {
    cy.get('#typeahead-multi-select').click();
    cy.get('#Florida-2').click();
    cy.get('.pf-v6-c-label').contains('Florida').should('exist');
    cy.get('#Alabama-0').click();
    cy.get('#Boston-1').click();
    cy.get('#Texas-4').click();
    cy.get('.pf-m-overflow > .pf-v6-c-button').should('exist');
    cy.get('#Florida-2').click();
    cy.get('.pf-v6-c-label').contains('Alabama').should('exist');
    cy.get('.pf-m-overflow > .pf-v6-c-button').should('not.exist');
    cy.get('#Florida-2').click();
    cy.get('.pf-m-overflow > .pf-v6-c-button').should('exist');
    cy.get('.pf-m-overflow > .pf-v6-c-button').click();
    cy.get('.pf-v6-c-label').contains('Florida').should('exist');
    cy.get('.pf-v6-c-label').contains('Alabama').should('exist');
    cy.get('.pf-v6-c-label').contains('.pf-v6-c-label', 'Florida').children('button').click();
    cy.get('.pf-v6-c-label').contains('Florida').should('not.exist');
    cy.get('button.pf-v6-c-select__toggle-clear').click();
  ...
  xit('Verify Custom Typeahead Multi Select', () => {
    ...
    cy.get('#Florida-2').click();
    cy.get('.pf-v6-c-label').contains('div-Florida-test_span').should('exist');
    cy.get('#Alabama-0').click();
    cy.get('#Boston-1').click();
    cy.get('#Texas-4').click();
    cy.get('button.pf-v6-c-select__toggle-clear').should('exist');
    cy.get('#Florida-2').click();
    cy.get('.pf-v6-c-label').contains('div-Alabama-test_span').should('exist');
    cy.get('.pf-m-overflow > .pf-v6-c-button').should('not.exist');
    cy.get('button.pf-v6-c-select__toggle-clear').click();
  });
  ...
  it('Verify Checkbox Select', () => {
    ...
    cy.get('.pf-v6-c-divider').should('exist');
    cy.get('input#Cancelled').click();
    cy.get('#check-select').contains('1').should('exist');
    cy.get('#check-select .pf-v6-c-select__toggle-badge').should('exist');
    cy.get('input#Paused').click();
    cy.get('#check-select').contains('2').should('exist');
    cy.get('#check-select').click();
    cy.get('.pf-v6-c-select__menu').should('not.exist');
  });

  it('Verify No Badge Checkbox Select', () => {
    cy.get('#check-select-no-badge').click();
    cy.get('input#Cancelled').click();
    cy.get('#check-select-no-badge .pf-v6-c-select__toggle-badge').should('not.exist');
  });
  ...
  it('Verify Checkbox Select on document body', () => {
    ...
    cy.get('#select-document-body-toggle .pf-v6-c-select__toggle-badge').should('exist');
    cy.get('input#Cancelled').click();
  ...
  it('Verify click on footer with menuAppendTo will not close select', () => {
    ...
    cy.get('#Miss > .pf-v6-c-select__menu-item').should('exist');
    cy.get('#Miss > .pf-v6-c-select__menu-item').click();
