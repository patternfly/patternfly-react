describe('Tab Uncontrolled Demo Test', () => {
  it('Navigate to demo section', () => {
    cy.visit('http://localhost:3000/');
    cy.get('#tab-uncontrolled-demo-nav-item-link').click();
    cy.url().should('eq', 'http://localhost:3000/tab-uncontrolled-demo-nav-link');
  });
