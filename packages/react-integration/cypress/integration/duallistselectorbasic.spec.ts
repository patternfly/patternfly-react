describe('Dual List Selector BasicDemo Test', () => {
  ...
  it('Verify existence', () => {
    cy.get('.pf-v5-c-dual-list-selector').should('exist');
  });

  it('Verify default aria-labels, status, and titles', () => {
    cy.get('.pf-m-available .pf-v5-c-dual-list-selector__title-text').contains('Available options');
    ...
    cy.get('.pf-m-chosen .pf-v5-c-dual-list-selector__title-text').contains('Chosen options');
  ...
  it('Verify selecting options', () => {
    ...
    cy.get('.pf-m-available .pf-v5-c-dual-list-selector__status-text').contains('1 of 4 items selected');
  });
  ...
  it('Verify selecting and choosing options', () => {
    ...
    cy.get('.pf-m-available .pf-v5-c-dual-list-selector__status-text').contains('0 of 2 items selected');
    cy.get('.pf-m-chosen .pf-v5-c-dual-list-selector__status-text').contains('0 of 2 items selected');
  });
