describe('Alert Demo Test', () => {
  ...
  it('Verify truncateTitle and no tooltip on short text', () => {
    cy.get('#default-alert > .pf-v6-c-alert__title')
  ...
  it('Verify truncateTitle alert and tooltip', () => {
    cy.get('#long-title-alert .pf-v6-c-alert__title')
      .should('have.class', 'pf-m-truncate')
  ...
  it('Verify expandable alert', () => {
    cy.get('#expandable-alert')
      ...
      .within(() => {
        cy.get('.pf-v6-c-alert__description').should('not.exist');
        cy.get('.pf-v6-c-alert__toggle').click();
        cy.get('.pf-v6-c-alert__description').should('exist');
