...
export const Demos: DemoInterface[] = [
  ...
  },
  {
    ...
    componentType: Examples.DualListSelectorDeprecatedBasicDemo
  },
  {
    id: 'dual-list-selector-deprecated-tree-demo',
    name: 'DualListSelector deprecated Tree Demo',
    componentType: Examples.DualListSelectorDeprecatedTreeDemo
  },
  {
    id: 'dual-list-selector-deprecated-with-actions-demo',
    name: 'DualListSelector deprecated with actions Demo',
    componentType: Examples.DualListSelectorDeprecatedWithActionsDemo
  },
  {
