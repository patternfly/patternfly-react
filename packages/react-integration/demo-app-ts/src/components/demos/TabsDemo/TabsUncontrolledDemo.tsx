import { createRef, Fragment, Component, RefObject } from 'react';
  ...
  render() {
    ...
    return (
      <Fragment>
        ...
        <Tabs id="unconnectedChildren" activeKey={0}>
          <Tab
        ...
        <Tabs id="mountOnEnter" mountOnEnter defaultActiveKey={0}>
        ...
        <Tabs id="unmountOnExit" unmountOnExit defaultActiveKey={0}>
          <Tab eventKey={0} title={<TabTitleText>Tab item 1</TabTitleText>}>
            Tab 1 section
          </Tab>
          <Tab eventKey={1} title={<TabTitleText>Tab item 2</TabTitleText>}>
        ...
        <Tabs id="boxTabs" defaultActiveKey={0} isBox>
          <Tab eventKey={0} title={<TabTitleText>Tab item 1</TabTitleText>}>
            Tab 1 section
          </Tab>
          <Tab eventKey={1} title={<TabTitleText>Tab item 2</TabTitleText>}>
        ...
        <Tabs id="verticalTabs" defaultActiveKey={0} isVertical>
          <Tab eventKey={0} title={<TabTitleText>Tab item 1</TabTitleText>}>
            Tab 1 section
          </Tab>
          <Tab eventKey={1} title={<TabTitleText>Tab item 2</TabTitleText>}>
        ...
        <Tabs id="filledTabs" defaultActiveKey={0} isFilled>
          <Tab eventKey={0} title={<TabTitleText>Tab item 1</TabTitleText>}>
            Tab 1 section
          </Tab>
          <Tab eventKey={1} title={<TabTitleText>Tab item 2</TabTitleText>}>
