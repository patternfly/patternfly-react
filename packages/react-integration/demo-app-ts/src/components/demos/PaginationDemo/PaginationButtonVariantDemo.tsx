...
export class PaginationButtonVariantDemo extends React.Component<
...
> {
  ...
  render() {
    return (
      <Stack hasGutter>
        {this.renderPaginationButtonVariant()}
        {this.renderDisabledButtonVariant()}
        {this.renderStickyButtonVariant()}
      </Stack>
    );
  }
}

export default PaginationButtonVariantDemo;
