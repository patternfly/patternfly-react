...
export class SkipToContentDemo extends React.Component<SkipToContentProps, {}> {
  static displayName = 'SkipToContentDemo';
  render() {
    const MockRouterLink = React.forwardRef((props: any, ref: any) => (
      <a className={`mock-router ${props.className ? props.className : ''}`} href={props.to} ref={ref}>
        {props.children}
      </a>
    ));
    return (
