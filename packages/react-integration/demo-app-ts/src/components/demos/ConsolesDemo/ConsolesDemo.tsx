...
export const ConsolesDemo: React.FunctionComponent<React.PropsWithChildren<unknown>> = () => {
...
const SerialConsoleCustom: React.FunctionComponent<React.PropsWithChildren<{
  type: string;
  typeText: string;
}>> = () => {
  const [status, setStatus] = React.useState('disconnected');
