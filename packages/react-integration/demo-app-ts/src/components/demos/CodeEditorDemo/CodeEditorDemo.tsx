    ...
    return (
      <>
        <Checkbox
          ...
          onChange={(_event: React.FormEvent<HTMLInputElement>, checked: boolean) => this.toggleDarkTheme(checked)}
        ...
        <Checkbox
          ...
          onChange={(_event: React.FormEvent<HTMLInputElement>, checked: boolean) => this.toggleLineNumbers(checked)}
        ...
        <Checkbox
          ...
          onChange={(_event: React.FormEvent<HTMLInputElement>, checked: boolean) => this.toggleReadOnly(checked)}
        ...
        <Checkbox
          ...
          onChange={(_event: React.FormEvent<HTMLInputElement>, checked: boolean) => this.toggleMinimap(checked)}
