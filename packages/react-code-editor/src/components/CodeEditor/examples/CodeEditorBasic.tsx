  ...
  return (
    <>
      <Checkbox
        ...
        onChange={(_event: React.FormEvent<HTMLInputElement>, checked: boolean) => toggleDarkTheme(checked)}
      ...
      <Checkbox
        ...
        onChange={(_event: React.FormEvent<HTMLInputElement>, checked: boolean) => toggleLineNumbers(checked)}
      ...
      <Checkbox
        ...
        onChange={(_event: React.FormEvent<HTMLInputElement>, checked: boolean) => toggleReadOnly(checked)}
      ...
      <Checkbox
        ...
        onChange={(_event: React.FormEvent<HTMLInputElement>, checked: boolean) => toggleMinimap(checked)}
