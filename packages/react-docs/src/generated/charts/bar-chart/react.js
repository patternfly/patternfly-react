...
const pageData = {
  ...
  "section": "charts",
  "source": "react",
  "slug": "/charts/bar-chart/react",
  "sourceLink": "https://github.com/patternfly/patternfly-react/blob/main/packages/react-charts/src/components/ChartBar/examples/ChartBar.md",
  "propComponents": [
    {
      "name": "Chart",
      "description": "",
...
pageData.examples = {
  ...
  'Purple with bottom aligned legend': props => 
...
const Component = () => (
  <React.Fragment>
    ...
    <p {...{"className":"ws-p"}}>
      <PatternflyThemeLink {...{"to":"https://katacoda.com/patternfly/courses/react-charts/bar-chart"}}>
        {`Start course`}
      </PatternflyThemeLink>
    </p>
    ...
    {React.createElement(pageData.examples["Purple with bottom aligned legend"])}
    {React.createElement(pageData.examples["Multi-color (ordered) with bottom-left aligned legend"])}
    {React.createElement(pageData.examples["Single with right aligned legend"])}
...
Component.displayName = 'ChartsBarChartReactDocs';
