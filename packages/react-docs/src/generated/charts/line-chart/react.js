...
const pageData = {
  ...
  "section": "charts",
  "source": "react",
  "slug": "/charts/line-chart/react",
  "sourceLink": "https://github.com/patternfly/patternfly-react/blob/main/packages/react-charts/src/components/ChartLine/examples/ChartLine.md",
  "propComponents": [
    {
      "name": "Chart",
      "description": "",
...
pageData.examples = {
  ...
  'Green with bottom aligned legend': props => 
...
const Component = () => (
  <React.Fragment>
    ...
    <p {...{"className":"ws-p"}}>
      <PatternflyThemeLink {...{"to":"https://katacoda.com/patternfly/courses/react-charts/line-chart"}}>
        {`Start course`}
      </PatternflyThemeLink>
    </p>
    ...
    {React.createElement(pageData.examples["Green with bottom aligned legend"])}
...
components used in the examples above, Victory pass-thru props are also documented here:`}
    ...
    <ul {...{"className":"ws-ul"}}>
      ...
      <li {...{"className":"ws-li"}}>
        ...
        {` props, see `}
        <PatternflyThemeLink {...{"to":"https://formidable.com/open-source/victory/docs/victory-zoom-container"}}>
          {`VictoryZoomContainerline`}
        </PatternflyThemeLink>
      </li>
    </ul>
  </React.Fragment>
