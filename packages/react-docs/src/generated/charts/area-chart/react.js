...
const pageData = {
  ...
  "section": "charts",
  "source": "react",
  "slug": "/charts/area-chart/react",
  "sourceLink": "https://github.com/patternfly/patternfly-react/blob/main/packages/react-charts/src/components/ChartArea/examples/ChartArea.md",
  "propComponents": [
    {
      "name": "Chart",
      "description": "",
    ...
    },
    {
      ...
      "props": [
        ...
        },
        {
          ...
          "defaultValue": "getThresholdTheme(themeColor, themeVariant)"
        },
        {
          "name": "themeColor",
          "type": "string",
...
pageData.examples = {
  ...
  'Cyan with bottom aligned legend and axis label': props => 
...
const Component = () => (
  <React.Fragment>
    ...
    <p {...{"className":"ws-p"}}>
      <PatternflyThemeLink {...{"to":"https://katacoda.com/patternfly/courses/react-charts/area-chart"}}>
        {`Start course`}
      </PatternflyThemeLink>
    </p>
    ...
    {React.createElement(pageData.examples["Cyan with bottom aligned legend and axis label"])}
    {React.createElement(pageData.examples["Multi-color (unordered) bottom-left aligned legend and responsive container"])}
...
Component.displayName = 'ChartsAreaChartReactDocs';
