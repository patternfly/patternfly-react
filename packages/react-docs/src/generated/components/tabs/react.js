  ...
  "propComponents": [
    {
      ...
      "props": [
        ...
        },
        {
          ...
          "type": "boolean",
          "description": "Enables no border bottom tab styling",
          "defaultValue": "true"
        },
        {
          "name": "id",
...
pageData.examples = {
  ...
  'With tooltip react ref': props => 
    <Example {...pageData} {...props} {...{"code":"import React from 'react';\nimport { Tabs, Tab, TabTitleText, Checkbox, Tooltip } from '@patternfly/react-core';\n\nclass SimpleTabs extends React.Component {\n  constructor(props) {\n    super(props);\n    this.state = {\n      activeTabKey: 0,\n      isBox: false\n    };\n    // Toggle currently active tab\n    this.handleTabClick = (event, tabIndex) => {\n      this.setState({\n        activeTabKey: tabIndex\n      });\n    };\n\n    this.toggleBox = checked => {\n      this.setState({\n        isBox: checked\n      });\n    };\n  }\n\n  render() {\n    const { activeTabKey, isBox } = this.state;\n    const tooltipRef = React.createRef();\n\n    return (\n      <div>\n        <Tabs activeKey={activeTabKey} onSelect={this.handleTabClick} isBox={isBox} aria-label=\"Tabs in the example with a tooltip ref\">\n          <Tab eventKey={0} title={<TabTitleText>Users</TabTitleText>}>\n            Users\n          </Tab>\n          <Tab eventKey={1} title={<TabTitleText>Containers</TabTitleText>}>\n            Containers\n          </Tab>\n          <Tab eventKey={2} title={<TabTitleText>Database</TabTitleText>}>\n            Database\n          </Tab>\n          <Tab eventKey={3} title={<TabTitleText>Disabled</TabTitleText>} isDisabled>\n            Disabled\n          </Tab>\n          <Tab eventKey={4} title={<TabTitleText>ARIA Disabled</TabTitleText>} isAriaDisabled>\n            ARIA Disabled\n          </Tab>\n          <Tab\n            eventKey={5}\n            title={<TabTitleText>ARIA Disabled (Tooltip)</TabTitleText>}\n            isAriaDisabled\n            ref={tooltipRef}\n            aria-describedby=\"tooltip-tab-5\"\n          >\n            ARIA Disabled (Tooltip)\n          </Tab>\n        </Tabs>\n        <Tooltip\n          content=\"Aria-disabled tabs are like disabled tabs, but focusable. Allows for tooltip support.\"\n          reference={tooltipRef}\n          id=\"tooltip-tab-5\"\n        />\n        <div style={{ marginTop: '20px' }}>\n          <Checkbox\n            label=\"isBox\"\n            isChecked={isBox}\n            onChange={this.toggleBox}\n            aria-label=\"show box variation checkbox\"\n            id=\"toggle-box\"\n            name=\"toggle-box\"\n          />\n        </div>\n      </div>\n    );\n  }\n}","title":"With tooltip react ref","lang":"js"}}>
      ...
      <p {...{"className":"ws-p"}}>
        {`When using a React ref to link a Tooltip to a Tab component, an `}
        
        <code {...{"className":"ws-code"}}>
          {`id`}
        </code>
        {` must be manually set on the Tooltip component, and the Tab component must have a matching `}
        
        <code {...{"className":"ws-code"}}>
          {`aria-describedby`}
        </code>
        {` attribute so that screen readers are able to announce the Tooltip contents.`}
      </p>
    </Example>,
  'Uncontrolled': props => 
