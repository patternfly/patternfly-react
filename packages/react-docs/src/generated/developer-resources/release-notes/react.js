...
const Component = () => (
  <React.Fragment>
    <AutoLinkHeader {...{"id":"2022.08-release-notes-2022-06-28","size":"h2","className":"ws-title ws-h2"}}>
      {`2022.08 release notes (2022-06-28)`}
    </AutoLinkHeader>
    <ul {...{"className":"ws-ul"}}>
      <li {...{"className":"ws-li"}}>
        <PatternflyThemeLink {...{"to":"https://www.npmjs.com/package/@patternfly/react-catalog-view-extension/v/4.75.0"}}>
          {`@patternfly/react-catalog-view-extension@4.75.0`}
        </PatternflyThemeLink>
      </li>
      <li {...{"className":"ws-li"}}>
        <PatternflyThemeLink {...{"to":"https://www.npmjs.com/package/@patternfly/react-charts/v/6.77.0"}}>
          {`@patternfly/react-charts@6.77.0`}
        </PatternflyThemeLink>
      </li>
      <li {...{"className":"ws-li"}}>
        <PatternflyThemeLink {...{"to":"https://www.npmjs.com/package/@patternfly/react-code-editor/v/4.65.0"}}>
          {`@patternfly/react-code-editor@4.65.0`}
        </PatternflyThemeLink>
      </li>
      <li {...{"className":"ws-li"}}>
        <PatternflyThemeLink {...{"to":"https://www.npmjs.com/package/@patternfly/react-core/v/4.224.0"}}>
          {`@patternfly/react-core@4.224.0`}
        </PatternflyThemeLink>
      </li>
      <li {...{"className":"ws-li"}}>
        <PatternflyThemeLink {...{"to":"https://www.npmjs.com/package/@patternfly/react-icons/v/4.75.0"}}>
          {`@patternfly/react-icons@4.75.0`}
        </PatternflyThemeLink>
      </li>
      <li {...{"className":"ws-li"}}>
        <PatternflyThemeLink {...{"to":"https://www.npmjs.com/package/@patternfly/react-inline-edit-extension/v/4.69.0"}}>
          {`@patternfly/react-inline-edit-extension@4.69.0`}
        </PatternflyThemeLink>
      </li>
      <li {...{"className":"ws-li"}}>
        <PatternflyThemeLink {...{"to":"https://www.npmjs.com/package/@patternfly/react-log-viewer/v/4.69.0"}}>
          {`@patternfly/react-log-viewer@4.69.0`}
        </PatternflyThemeLink>
      </li>
      <li {...{"className":"ws-li"}}>
        <PatternflyThemeLink {...{"to":"https://www.npmjs.com/package/@patternfly/react-styles/v/4.74.0"}}>
          {`@patternfly/react-styles@4.74.0`}
        </PatternflyThemeLink>
      </li>
      <li {...{"className":"ws-li"}}>
        <PatternflyThemeLink {...{"to":"https://www.npmjs.com/package/@patternfly/react-table/v/4.93.0"}}>
          {`@patternfly/react-table@4.93.0`}
        </PatternflyThemeLink>
      </li>
      <li {...{"className":"ws-li"}}>
        <PatternflyThemeLink {...{"to":"https://www.npmjs.com/package/@patternfly/react-tokens/v/4.76.0"}}>
          {`@patternfly/react-tokens@4.76.0`}
        </PatternflyThemeLink>
      </li>
      <li {...{"className":"ws-li"}}>
        <PatternflyThemeLink {...{"to":"https://www.npmjs.com/package/@patternfly/react-topology/v/4.71.0"}}>
          {`@patternfly/react-topology@4.71.0`}
        </PatternflyThemeLink>
      </li>
      <li {...{"className":"ws-li"}}>
        <PatternflyThemeLink {...{"to":"https://www.npmjs.com/package/@patternfly/react-virtualized-extension/v/4.71.0"}}>
          {`@patternfly/react-virtualized-extension@4.71.0`}
        </PatternflyThemeLink>
      </li>
    </ul>
    ...
    <ul {...{"className":"ws-ul"}}>
      <li {...{"className":"ws-li"}}>
        ...
        <ul {...{"className":"ws-ul"}}>
          <li {...{"className":"ws-li"}}>
            {`Updated to match PatternFly core (`}
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7503"}}>
              {`#7503`}
            </PatternflyThemeLink>
            {`)`}
          </li>
      ...
      <li {...{"className":"ws-li"}}>
        ...
        <ul {...{"className":"ws-ul"}}>
          <li {...{"className":"ws-li"}}>
            {`Enabled date picker in a modal (`}
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7416"}}>
              {`#7416`}
            </PatternflyThemeLink>
            {`)`}
          </li>
      ...
      <li {...{"className":"ws-li"}}>
        ...
        <ul {...{"className":"ws-ul"}}>
          <li {...{"className":"ws-li"}}>
            {`Fixed type error on resize (`}
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7531"}}>
              {`#7531`}
            </PatternflyThemeLink>
            {`)`}
          </li>
      ...
      <li {...{"className":"ws-li"}}>
        ...
        <ul {...{"className":"ws-ul"}}>
          <li {...{"className":"ws-li"}}>
            ...
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7524"}}>
              {`#7524`}
            </PatternflyThemeLink>
            {`)`}
          </li>
      ...
      <li {...{"className":"ws-li"}}>
        ...
        <ul {...{"className":"ws-ul"}}>
          <li {...{"className":"ws-li"}}>
            ...
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7458"}}>
              {`#7458`}
            </PatternflyThemeLink>
            {`)`}
          </li>
      ...
      <li {...{"className":"ws-li"}}>
        ...
        <ul {...{"className":"ws-ul"}}>
          <li {...{"className":"ws-li"}}>
            {`Converted empty state demos to TypeScript (`}
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7496"}}>
              {`#7496`}
            </PatternflyThemeLink>
            {`)`}
          </li>
      ...
      <li {...{"className":"ws-li"}}>
        ...
        <ul {...{"className":"ws-ul"}}>
          <li {...{"className":"ws-li"}}>
            {`Converted examples to TypeScript (`}
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7506"}}>
              {`#7506`}
            </PatternflyThemeLink>
            {`)`}
          </li>
      ...
      <li {...{"className":"ws-li"}}>
        ...
        <ul {...{"className":"ws-ul"}}>
          <li {...{"className":"ws-li"}}>
            ...
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7514"}}>
              {`#7514`}
            </PatternflyThemeLink>
            {`)`}
          </li>
      ...
      <li {...{"className":"ws-li"}}>
        ...
        <ul {...{"className":"ws-ul"}}>
          <li {...{"className":"ws-li"}}>
            {`Added functionality for form group roles (`}
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7516"}}>
              {`#7516`}
            </PatternflyThemeLink>
            {`)`}
          </li>
          <li {...{"className":"ws-li"}}>
            {`Converted examples to TypeScript/functional components (`}
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7521"}}>
              {`#7521`}
            </PatternflyThemeLink>
            {`)`}
          </li>
      ...
      <li {...{"className":"ws-li"}}>
        ...
        <ul {...{"className":"ws-ul"}}>
          <li {...{"className":"ws-li"}}>
            {`Converted examples to TypeScript (`}
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7489"}}>
              {`#7489`}
            </PatternflyThemeLink>
            {`)`}
          </li>
      ...
      <li {...{"className":"ws-li"}}>
        ...
        <ul {...{"className":"ws-ul"}}>
          <li {...{"className":"ws-li"}}>
            {`Converted helper text examples to TypeScript (`}
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7488"}}>
              {`#7488`}
            </PatternflyThemeLink>
            {`)`}
          </li>
      ...
      <li {...{"className":"ws-li"}}>
        ...
        <ul {...{"className":"ws-ul"}}>
          <li {...{"className":"ws-li"}}>
            {`Converted hint examples to TypeScript (`}
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7487"}}>
              {`#7487`}
            </PatternflyThemeLink>
            {`)`}
          </li>
      ...
      <li {...{"className":"ws-li"}}>
        ...
        <ul {...{"className":"ws-ul"}}>
          <li {...{"className":"ws-li"}}>
            {`Converted examples to TypeScript (`}
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7493"}}>
              {`#7493`}
            </PatternflyThemeLink>
            {`)`}
          </li>
      ...
      <li {...{"className":"ws-li"}}>
        ...
        <ul {...{"className":"ws-ul"}}>
          <li {...{"className":"ws-li"}}>
            {`Added jump links with drawer demo (`}
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7520"}}>
              {`#7520`}
            </PatternflyThemeLink>
            {`)`}
          </li>
          <li {...{"className":"ws-li"}}>
            {`Converted examples to TypeScript (`}
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7551"}}>
              {`#7551`}
            </PatternflyThemeLink>
            {`)`}
          </li>
      ...
      <li {...{"className":"ws-li"}}>
        ...
        <ul {...{"className":"ws-ul"}}>
          <li {...{"className":"ws-li"}}>
            {`Added gold color for label (`}
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7528"}}>
              {`#7528`}
            </PatternflyThemeLink>
            {`)`}
          </li>
          <li {...{"className":"ws-li"}}>
            {`Converted label demos to TypeScript (`}
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7543"}}>
              {`#7543`}
            </PatternflyThemeLink>
            {`)`}
          </li>
      ...
      <li {...{"className":"ws-li"}}>
        ...
        <ul {...{"className":"ws-ul"}}>
          <li {...{"className":"ws-li"}}>
            {`Added editable label examples (`}
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7515"}}>
              {`#7515`}
            </PatternflyThemeLink>
            {`)`}
          </li>
          <li {...{"className":"ws-li"}}>
            {`Converted examples to TypeScript (`}
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7558"}}>
              {`#7558`}
            </PatternflyThemeLink>
            {`)`}
          </li>
      ...
      <li {...{"className":"ws-li"}}>
        ...
        <ul {...{"className":"ws-ul"}}>
          <li {...{"className":"ws-li"}}>
            {`Converted all examples to TypeScript (`}
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7550"}}>
              {`#7550`}
            </PatternflyThemeLink>
            {`)`}
          </li>
      ...
      <li {...{"className":"ws-li"}}>
        ...
        <ul {...{"className":"ws-ul"}}>
          <li {...{"className":"ws-li"}}>
            ...
            {` props correctly in documentation (`}
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7545"}}>
              {`#7545`}
            </PatternflyThemeLink>
            {`)`}
          </li>
      ...
      <li {...{"className":"ws-li"}}>
        ...
        <ul {...{"className":"ws-ul"}}>
          <li {...{"className":"ws-li"}}>
            {`Added support for keyboard interactions (`}
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7532"}}>
              {`#7532`}
            </PatternflyThemeLink>
            {`)`}
          </li>
      ...
      <li {...{"className":"ws-li"}}>
        ...
        <ul {...{"className":"ws-ul"}}>
          <li {...{"className":"ws-li"}}>
            {`Added check for updates in grouped select options (`}
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7530"}}>
              {`#7530`}
            </PatternflyThemeLink>
            {`)`}
          </li>
          <li {...{"className":"ws-li"}}>
            {`Updated to retain focus on correct checkbox after view more clicked (`}
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7505"}}>
              {`#7505`}
            </PatternflyThemeLink>
            {`)`}
          </li>
      ...
      <li {...{"className":"ws-li"}}>
        ...
        <ul {...{"className":"ws-ul"}}>
          <li {...{"className":"ws-li"}}>
            {`Updated insets example to make more sense (`}
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7480"}}>
              {`#7480`}
            </PatternflyThemeLink>
            {`)`}
          </li>
      ...
      <li {...{"className":"ws-li"}}>
        ...
        <ul {...{"className":"ws-ul"}}>
          <li {...{"className":"ws-li"}}>
            {`Added support for additional information panel (drawer) (`}
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7323"}}>
              {`#7323`}
            </PatternflyThemeLink>
            {`)`}
          </li>
          <li {...{"className":"ws-li"}}>
            {`Wrapped Wizard modal example in page (`}
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7502"}}>
              {`#7502`}
            </PatternflyThemeLink>
            {`)`}
          </li>
    ...
    <ul {...{"className":"ws-ul"}}>
      <li {...{"className":"ws-li"}}>
        {`Added SUSE instruction for virt-viewer (`}
        <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7445"}}>
          {`#7445`}
        </PatternflyThemeLink>
        {`)`}
      </li>
    ...
    <ul {...{"className":"ws-ul"}}>
      <li {...{"className":"ws-li"}}>
        ...
        <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7390"}}>
          {`#7390`}
        </PatternflyThemeLink>
        {`)`}
      </li>
      <li {...{"className":"ws-li"}}>
        {`Simplified pattern visibility (`}
        <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7542"}}>
          {`#7542`}
        </PatternflyThemeLink>
        {`)`}
      </li>
    ...
    <ul {...{"className":"ws-ul"}}>
      <li {...{"className":"ws-li"}}>
        {`Updated to account for added columns with expandable (`}
        <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7529"}}>
          {`#7529`}
        </PatternflyThemeLink>
        {`)`}
      </li>
      <li {...{"className":"ws-li"}}>
        {`Added nested sticky header support (`}
        <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7595"}}>
          {`#7595`}
        </PatternflyThemeLink>
        {`)`}
      </li>
      <li {...{"className":"ws-li"}}>
        {`Fixed filterable table demo icon text spacing (`}
        <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7477"}}>
          {`#7477`}
        </PatternflyThemeLink>
        {`)`}
      </li>
      <li {...{"className":"ws-li"}}>
        {`Updated expandable examples to set column widths (`}
        <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7513"}}>
          {`#7513`}
        </PatternflyThemeLink>
        {`)`}
      </li>
    ...
    <ul {...{"className":"ws-ul"}}>
      <li {...{"className":"ws-li"}}>
        {`Fixed group position when it has no children (`}
        <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7573"}}>
          {`#7573`}
        </PatternflyThemeLink>
        {`)`}
      </li>
    ...
    <ul {...{"className":"ws-ul"}}>
      <li {...{"className":"ws-li"}}>
        ...
        <ul {...{"className":"ws-ul"}}>
          <li {...{"className":"ws-li"}}>
            {`Added additional type-casts for React nodes (`}
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7402"}}>
              {`#7402`}
            </PatternflyThemeLink>
            {`)`}
          </li>
      ...
      <li {...{"className":"ws-li"}}>
        ...
        <ul {...{"className":"ws-ul"}}>
          <li {...{"className":"ws-li"}}>
            {`Updated card view demo to remove highlight on selected cards (used checkboxes only) and to include mixed state (-) check indicator (`}
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7562"}}>
              {`#7562`}
            </PatternflyThemeLink>
            {`)`}
          </li>
          <li {...{"className":"ws-li"}}>
            {`Align demo dashboard header with core (`}
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7518"}}>
              {`#7518`}
            </PatternflyThemeLink>
            {`)`}
          </li>
      ...
      <li {...{"className":"ws-li"}}>
        ...
        <ul {...{"className":"ws-ul"}}>
          <li {...{"className":"ws-li"}}>
            {`Update dependency theme-patternfly-org to v0.11.68 (`}
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7593"}}>
              {`#7593`}
            </PatternflyThemeLink>
            {`)`}
          </li>
          <li {...{"className":"ws-li"}}>
            {`Bumped patternfly-a11y and fixed virtualized table violations (`}
            <PatternflyThemeLink {...{"to":"https://github.com/patternfly/patternfly-react/pull/7510"}}>
              {`#7510`}
            </PatternflyThemeLink>
            {`)`}
          </li>
...
Replaced recompose with react-recompose (`}
    ...
    <AutoLinkHeader {...{"id":"other-17","size":"h2","className":"ws-title ws-h2"}}>
      {`Other`}
    </AutoLinkHeader>
    <ul {...{"className":"ws-ul"}}>
      <li {...{"className":"ws-li"}}>
    ...
    <AutoLinkHeader {...{"id":"access-console-extension-7","size":"h3","className":"ws-title ws-h3"}}>
      {`Access console extension`}
    </AutoLinkHeader>
    <ul {...{"className":"ws-ul"}}>
      <li {...{"className":"ws-li"}}>
    ...
    <AutoLinkHeader {...{"id":"topology-18","size":"h3","className":"ws-title ws-h3"}}>
      {`Topology`}
    </AutoLinkHeader>
    <ul {...{"className":"ws-ul"}}>
      <li {...{"className":"ws-li"}}>
    ...
    <AutoLinkHeader {...{"id":"charts-18","size":"h3","className":"ws-title ws-h3"}}>
      {`Charts`}
    </AutoLinkHeader>
    <ul {...{"className":"ws-ul"}}>
      <li {...{"className":"ws-li"}}>
...
(`}
    ...
    <AutoLinkHeader {...{"id":"table-37","size":"h3","className":"ws-title ws-h3"}}>
      {`Table`}
    </AutoLinkHeader>
    <ul {...{"className":"ws-ul"}}>
      <li {...{"className":"ws-li"}}>
...
(`}
    ...
    <AutoLinkHeader {...{"id":"other-42","size":"h3","className":"ws-title ws-h3"}}>
      {`Other`}
    </AutoLinkHeader>
    <ul {...{"className":"ws-ul"}}>
      <li {...{"className":"ws-li"}}>
