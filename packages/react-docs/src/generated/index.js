module.exports = {
  ...
  '/components/divider/react': {
    id: "Divider",
    title: "Divider",
    toc: [{"text":"Examples"},[{"text":"Using hr"},{"text":"Using li"},{"text":"Using div"},{"text":"Inset medium"},{"text":"Inset at various breakpoints"},{"text":"Vertical in flex layout"},{"text":"Vertical in flex layout, inset medium"},{"text":"Vertical in flex layout, inset at various breakpoints"}]],
    examples: ["Using hr","Using li","Using div","Inset medium","Inset at various breakpoints","Vertical in flex layout","Vertical in flex layout, inset medium","Vertical in flex layout, inset at various breakpoints"],
    section: "components",
    source: "react",
  ...
  '/components/dual-list-selector/react': {
    ...
    toc: [{"text":"Examples"},[{"text":"Basic"},{"text":"Basic with tooltips"},{"text":"Basic with search"},{"text":"Using more complex options with actions"},{"text":"Expandable options"},{"text":"Composable dual list selector"},{"text":"Reordering lists using drag and drop"},{"text":"Composable dual list selector tree"}]],
  ...
  '/components/expandable-section/react': {
    ...
    toc: [{"text":"Examples"},[{"text":"Basic"},{"text":"Uncontrolled"},{"text":"Uncontrolled with dynamic toggle text"},{"text":"Detached"},{"text":"Disclosure variation"},{"text":"Indented"}]],
  ...
  '/components/form-select/react': {
    id: "Form select",
    title: "Form select",
    toc: [{"text":"Examples"},[{"text":"Basic"},{"text":"Invalid"},{"text":"Validated"},{"text":"Disabled"},{"text":"Grouped"},{"text":"Icon sprite variant"}]],
    examples: ["Basic","Invalid","Validated","Disabled","Grouped","Icon sprite variant"],
    section: "components",
    source: "react",
  ...
  '/components/label-group/react': {
    id: "Label group",
    title: "Label group",
    toc: [{"text":"Examples"},[{"text":"Basic"},{"text":"Overflow"},{"text":"Category"},{"text":"Category removable"},{"text":"Vertical category overflow removable"},{"text":"Editable labels"}]],
  ...
  '/components/modal/react': {
    id: "Modal",
    title: "Modal",
    toc: [{"text":"Examples"},[{"text":"Basic"},{"text":"With description"},{"text":"Top aligned"},{"text":"Small"},{"text":"Medium"},{"text":"Large"},{"text":"Width"},{"text":"Custom header and footer"},{"text":"No header"},{"text":"Custom Icon"},{"text":"Warning Alert"},{"text":"With wizard"},{"text":"With dropdown"},{"text":"With help"},{"text":"With form"}]],
    examples: ["Basic","With description","Top aligned","Small","Medium","Large","Width","Custom header and footer","No header","Custom Icon","Warning Alert","With wizard","With dropdown","With help","With form"],
    section: "components",
    source: "react",
  ...
  '/components/page/react': {
    id: "Page",
    title: "Page",
    toc: [{"text":"Examples"},[{"text":"Vertical nav"},{"text":"Horizontal nav"},{"text":"Tertiary nav"},{"text":"With or without fill"},{"text":"Main section padding"},{"text":"Uncontrolled nav"},{"text":"Group section"},{"text":"Vertical nav using PageHeader component"},{"text":"Centered content"}]],
    examples: ["Vertical nav","Horizontal nav","Tertiary nav","With or without fill","Main section padding","Uncontrolled nav","Group section","Vertical nav using PageHeader component","Centered content"],
    section: "components",
    source: "react",
  ...
  '/components/tooltip/react': {
    id: "Tooltip",
    title: "Tooltip",
    toc: [{"text":"Examples"},[{"text":"Basic"},{"text":"Tooltip react ref"},{"text":"Tooltip selector ref"},{"text":"On icon"},{"text":"Options"}]],
    examples: ["Basic","Tooltip react ref","Tooltip selector ref","On icon","Options"],
    section: "components",
    source: "react",
  ...
  '/components/wizard/react': {
    id: "Wizard",
    title: "Wizard",
    toc: [{"text":"Examples"},[{"text":"Basic"},{"text":"Anchors for nav items"},{"text":"Incrementally enabled steps"},{"text":"Expandable steps"},{"text":"Finished"},{"text":"Enabled on form validation"},{"text":"Validate on button press"},{"text":"Progressive steps"},{"text":"Remember last step"},{"text":"Wizard in modal"}]],
  ...
  '/demos/composable-menu/react-demos': {
    ...
    toc: [{"text":"Demos"},[{"text":"Composable simple dropdown"},{"text":"Composable actions menu"},{"text":"Composable simple select"},{"text":"Composable drilldown menu"},{"text":"Composable tree view menu"},{"text":"Composable flyout"},{"text":"Composable application launcher"},{"text":"Composable context selector"},{"text":"Composable options menu variants"},{"text":"Composable dropdown variants"},{"text":"Composable date select"}]],
    examples: ["Composable simple dropdown","Composable actions menu","Composable simple select","Composable drilldown menu","Composable tree view menu","Composable flyout","Composable application launcher","Composable context selector","Composable options menu variants","Composable dropdown variants","Composable date select"],
    section: "demos",
    source: "react-demos",
  ...
  '/components/date-picker/react-demos': {
    id: "Date picker",
    title: "Date picker",
    toc: [{"text":"Demos"},[{"text":"Date range picker"},{"text":"Date and time range picker"}]],
  ...
  '/components/jump-links/react-demos': {
    id: "Jump links",
    title: "Jump links",
    toc: [{"text":"Demos"},[{"text":"Scrollspy with subsections"}]],
    fullscreenExamples: ["Scrollspy with subsections"],
    section: "components",
    source: "react-demos",
  ...
  '/components/tabs/react-demos': {
    id: "Tabs",
    title: "Tabs",
    toc: [{"text":"Demos"},[{"text":"Open tabs"},{"text":"Open tabs with secondary tabs"},{"text":"Nested tabs"},{"text":"Tables and tabs"},{"text":"Tables and tabs, auto width tabs"},{"text":"Modal tabs"},{"text":"Gray tabs"}]],
    fullscreenExamples: ["Open tabs","Open tabs with secondary tabs","Nested tabs","Tables and tabs","Tables and tabs, auto width tabs","Modal tabs","Gray tabs"],
    section: "components",
    source: "react-demos",
  ...
  '/components/wizard/react-demos': {
    id: "Wizard",
    title: "Wizard",
    toc: [{"text":"Demos"},[{"text":"In Modal"},{"text":"In Page"}]],
  ...
  '/charts/legend-chart/react': {
    ...
    section: "charts",
    source: "react",
    Component: () => import(/* webpackChunkName: "charts/legend-chart/react/index" */ './charts/legend-chart/react')
  },
  ...
  '/charts/tooltip-chart/react': {
    ...
    section: "charts",
    source: "react",
    Component: () => import(/* webpackChunkName: "charts/tooltip-chart/react/index" */ './charts/tooltip-chart/react')
  },
  ...
  '/developer-resources/release-notes/react': {
    id: "Release notes",
    title: "Release notes",
    toc: [{"text":"2022.04 release notes (2022-04-07)"},[{"text":"Components"},{"text":"Table"},{"text":"Topology"},{"text":"Other"}],{"text":"2022.03 release notes (2022-03-09)"},[{"text":"Components","id":"components-0"},{"text":"Table","id":"table-0"},{"text":"Topology","id":"topology-0"},{"text":"Other","id":"other-0"}],{"text":"2022.02 release notes (2022-02-22)"},[{"text":"Components","id":"components-1"},{"text":"Catalog view extension"},{"text":"Table","id":"table-1"},{"text":"Topology","id":"topology-1"},{"text":"Other","id":"other-1"}],{"text":"2022.01 release notes (2022-01-25)"},[{"text":"Components","id":"components-2"},{"text":"Log viewer"},{"text":"Table","id":"table-2"},{"text":"Topology","id":"topology-2"},{"text":"Other","id":"other-2"}],{"text":"2021.16 release notes (2021-12-13)"},[{"text":"Components","id":"components-3"},{"text":"Table","id":"table-3"},{"text":"Other","id":"other-3"}],{"text":"2021.15 release notes (2021-11-17)"},[{"text":"Components","id":"components-4"},{"text":"Access console extension"},{"text":"Charts"},{"text":"Code editor"},{"text":"Log viewer","id":"log-viewer-0"},{"text":"Table","id":"table-4"},{"text":"Topology","id":"topology-3"},{"text":"Other","id":"other-4"}],{"text":"2021.14 release notes (2021-10-26)"},[{"text":"Components","id":"components-5"},{"text":"Access console extension","id":"access-console-extension-0"},{"text":"Log viewer extension"},{"text":"React tokens"},{"text":"Table","id":"table-5"},{"text":"Other","id":"other-5"},{"text":"PF3"}],{"text":"2021.13 release notes (2021-10-13)"},[{"text":"Components","id":"components-6"},{"text":"Catalog view extension","id":"catalog-view-extension-0"},{"text":"Charts","id":"charts-0"},{"text":"Log viewer extension","id":"log-viewer-extension-0"},{"text":"Table","id":"table-6"},{"text":"Tokens"},{"text":"Other","id":"other-6"}],{"text":"2021.12 release notes (2021-09-15)"},[{"text":"Components","id":"components-7"},{"text":"Log viewer extension","id":"log-viewer-extension-1"},{"text":"Table","id":"table-7"},{"text":"Other","id":"other-7"}],{"text":"2021.11 release notes (2021-08-25)"},[{"text":"Components","id":"components-8"},{"text":"Icons"},{"text":"Log viewer extension","id":"log-viewer-extension-2"},{"text":"Table","id":"table-8"},{"text":"Tokens","id":"tokens-0"},{"text":"Other","id":"other-8"}],{"text":"2021.10 release notes (2021-08-04)"},[{"text":"Components","id":"components-9"},{"text":"Access console extension","id":"access-console-extension-1"},{"text":"Charts","id":"charts-1"},{"text":"Log viewer extension","id":"log-viewer-extension-3"},{"text":"Table","id":"table-9"},{"text":"Other","id":"other-9"}],{"text":"2021.08 release notes (2021-06-22)"},[{"text":"Components","id":"components-10"},{"text":"Charts","id":"charts-2"},{"text":"Log Viewer","id":"log-viewer-1"},{"text":"Table","id":"table-10"},{"text":"Other","id":"other-10"}],{"text":"2021.07 release notes (2021-06-04)"},[{"text":"Components","id":"components-11"},{"text":"Charts","id":"charts-3"},{"text":"Table","id":"table-11"},{"text":"Other","id":"other-11"}],{"text":"2021.06 release notes (2021-05-14)"},[{"text":"Components","id":"components-12"},{"text":"Access console extension","id":"access-console-extension-2"},{"text":"Log viewer","id":"log-viewer-2"},{"text":"Table","id":"table-12"},{"text":"Other","id":"other-12"}],{"text":"2021.05 release notes (2021-04-21)"},[{"text":"Components","id":"components-13"},{"text":"Access console extension","id":"access-console-extension-3"},{"text":"Icons","id":"icons-0"},{"text":"Inline edit extension"},{"text":"Tokens","id":"tokens-1"},{"text":"Table","id":"table-13"},{"text":"Virtualized extension"}],{"text":"Other","id":"other-13"},{"text":"2021.04 release notes (2021-04-01)"},[{"text":"Components","id":"components-14"},{"text":"Table","id":"table-14"},{"text":"Topology","id":"topology-4"},{"text":"Other","id":"other-14"}],{"text":"2021.03 release notes (2021-03-10)"},[{"text":"Components","id":"components-15"},{"text":"Other","id":"other-15"}],{"text":"2021.02 release notes (2021-02-17)"},[{"text":"Components","id":"components-16"},{"text":"Charts","id":"charts-4"},{"text":"Table","id":"table-15"},{"text":"Topology","id":"topology-5"},{"text":"Virtualized extension","id":"virtualized-extension-0"},{"text":"Other","id":"other-16"}],{"text":"2021.01 release notes (2021-01-27)"},[{"text":"Components","id":"components-17"},{"text":"Access console extension","id":"access-console-extension-4"},{"text":"Charts","id":"charts-5"},{"text":"Table","id":"table-16"},{"text":"Topology","id":"topology-6"},{"text":"Other","id":"other-17"}],{"text":"2020.16 release notes (2020-12-11)"},[{"text":"Components","id":"components-18"},{"text":"Access console extension","id":"access-console-extension-5"},{"text":"Chart"},{"text":"Table","id":"table-17"},{"text":"Topology","id":"topology-7"},{"text":"Other","id":"other-18"}],{"text":"2020.15 release notes (2020-11-17)"},[{"text":"Components","id":"components-19"},{"text":"Access console extension","id":"access-console-extension-6"},{"text":"Catalog view extension","id":"catalog-view-extension-1"},{"text":"Date time"},{"text":"Table","id":"table-18"},{"text":"Virtualized extension","id":"virtualized-extension-1"},{"text":"Other","id":"other-19"}],{"text":"2020.14 release notes (2020-10-27)"},[{"text":"Components","id":"components-20"},{"text":"Catalog view extension","id":"catalog-view-extension-2"},{"text":"Chart","id":"chart-0"},{"text":"Table","id":"table-19"},{"text":"Topology","id":"topology-8"},{"text":"Other","id":"other-20"}],{"text":"2020.13 release notes (2020-10-06)"},[{"text":"Components","id":"components-21"},{"text":"Catalog view extension","id":"catalog-view-extension-3"},{"text":"Charts","id":"charts-6"},{"text":"Icons","id":"icons-1"},{"text":"Table","id":"table-20"},{"text":"Topology","id":"topology-9"},{"text":"Other","id":"other-21"},{"text":"PF3","id":"pf3-0"}],{"text":"2020.12 release notes (2020-09-17)"},[{"text":"Components","id":"components-22"},{"text":"Topology","id":"topology-10"},{"text":"Other","id":"other-22"}],{"text":"2020.11 release notes (2020-08-26)"},[{"text":"Components","id":"components-23"},{"text":"Catalog view extension","id":"catalog-view-extension-4"},{"text":"Table","id":"table-21"},{"text":"Other","id":"other-23"}],{"text":"2020.10 release notes (2020-08-17)"},[{"text":"Components","id":"components-24"},{"text":"Charts","id":"charts-7"},{"text":"Table","id":"table-22"},{"text":"Tokens","id":"tokens-2"},{"text":"Topology","id":"topology-11"},{"text":"Other","id":"other-24"}],{"text":"2020.09 release notes (2020-07-17)"},[{"text":"Components","id":"components-25"},{"text":"Table","id":"table-23"},{"text":"Topology","id":"topology-12"},{"text":"Other","id":"other-25"}],{"text":"2020.08 release notes (2020-06-24)"},[{"text":"Components","id":"components-26"},{"text":"Charts","id":"charts-8"},{"text":"Table","id":"table-24"},{"text":"Topology","id":"topology-13"},{"text":"Virtualized extension","id":"virtualized-extension-2"},{"text":"Other","id":"other-26"}],{"text":"2020.07 release notes (2020-06-05)"},{"text":"2020.06 release notes (2020-05-12)"},[{"text":"Components","id":"components-27"},{"text":"Charts","id":"charts-9"},{"text":"Other","id":"other-27"}],{"text":"2020.05 release notes (2020-04-21)"},[{"text":"Components","id":"components-28"},{"text":"Other","id":"other-28"}],{"text":"2020.04 release notes (2020-03-31)"},[{"text":"Components","id":"components-29"},{"text":"Table","id":"table-25"},{"text":"Other","id":"other-29"}],{"text":"2020.03 release notes (2020-03-10)"},[{"text":"Components","id":"components-30"},{"text":"Catalog view extension","id":"catalog-view-extension-5"},{"text":"Other","id":"other-30"},{"text":"Virtualized extension","id":"virtualized-extension-3"},{"text":"PF3","id":"pf3-1"}],{"text":"2020.02 release notes (2020-02-18)"},[{"text":"Components","id":"components-31"},{"text":"Catalog view extension","id":"catalog-view-extension-6"},{"text":"Table","id":"table-26"},{"text":"Other","id":"other-31"},{"text":"PF3","id":"pf3-2"}],{"text":"2020.01 release notes (2020-01-28)"},[{"text":"Components","id":"components-32"},{"text":"Catalog view extension","id":"catalog-view-extension-7"},{"text":"Table","id":"table-27"},{"text":"Other","id":"other-32"},{"text":"PF3","id":"pf3-3"}],{"text":"2019.11 release notes (2019-12-18)"},[{"text":"Charts","id":"charts-10"},{"text":"Components","id":"components-33"},{"text":"Table","id":"table-28"},{"text":"Other","id":"other-33"},{"text":"PF3","id":"pf3-4"}],{"text":"2019.10 release notes (2019-11-25)"},[{"text":"Charts","id":"charts-11"},{"text":"Components","id":"components-34"},{"text":"Catalog view extension","id":"catalog-view-extension-8"},{"text":"Table","id":"table-29"},{"text":"Topology","id":"topology-14"},{"text":"Other","id":"other-34"},{"text":"PF3","id":"pf3-5"}],{"text":"2019.09 release notes (2019-11-01)"},[{"text":"Charts","id":"charts-12"},{"text":"Components","id":"components-35"},{"text":"Table","id":"table-30"},{"text":"Other","id":"other-35"},{"text":"PF3","id":"pf3-6"}],{"text":"2019.08 release notes (2019-10-01)"},[{"text":"Charts","id":"charts-13"},{"text":"Components","id":"components-36"},{"text":"Table","id":"table-31"},{"text":"Other","id":"other-36"}],{"text":"2019.07 release notes (2019-09-10)"},[{"text":"Charts","id":"charts-14"},{"text":"Components","id":"components-37"},{"text":"Table","id":"table-32"},{"text":"Icons","id":"icons-2"},{"text":"Virtualized Extension","id":"virtualized-extension-4"},{"text":"PF3","id":"pf3-7"}],{"text":"2019.06 release notes (2019-08-13)"},[{"text":"Charts","id":"charts-15"},{"text":"Components","id":"components-38"},{"text":"Table","id":"table-33"},{"text":"TypeScript conversion"},{"text":"Docs"},{"text":"Other","id":"other-37"}],{"text":"2019.05 release notes (2019-07-24)"},[{"text":"Charts (@patternfly/react-charts@4.7.1)"},{"text":"Components (@patternfly/react-core@3.75.2)"},{"text":"TypeScript conversion","id":"typescript-conversion-0"},{"text":"Table (@patternfly/react-table@2.14.23)"},{"text":"Styles (@patternfly/react-styles@3.5.7)"},{"text":"Docs","id":"docs-0"},{"text":"Other","id":"other-38"}],{"text":"2019.04 release notes (2019-07-02)"},[{"text":"Charts (@patternfly/react-charts@4.4.7)"},{"text":"Components (@patternfly/react-core@3.58.1)"},{"text":"TypeScript conversion","id":"typescript-conversion-1"}],{"text":"2019.03 release notes (2019-06-11)"},[{"text":"Charts (@patternfly/react-charts@4.1.5)"},{"text":"Components (@patternfly/react-core@3.38.1)"},{"text":"Table (@patternfly/react-table@2.11.1)"},{"text":"Topology (@patternfly/react-topology)"},{"text":"Styles (@patternfly/react-styles@3.3.3)"},{"text":"TypeScript conversion","id":"typescript-conversion-2"}],{"text":"2019.02 release notes (2019-06-05)"},[{"text":"Components (@patternfly/react-core@3.34.2)"},{"text":"Charts @patternfly/react-charts@3.6.4"},{"text":"Docs","id":"docs-1"},{"text":"TypeScript conversion","id":"typescript-conversion-3"}],{"text":"2019.01 release notes (2019-05-02)"}],
    section: "developer-resources",
    source: "react",
