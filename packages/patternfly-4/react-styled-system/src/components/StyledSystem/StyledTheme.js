...
export const StyledConstants = {
  ...
  shadows: {
    sm: global_BoxShadow_sm.var,
    sm_left: global_BoxShadow_sm_left.var,
    sm_right: global_BoxShadow_sm_right.var,
    sm_bottom: global_BoxShadow_sm_bottom.var,
    sm_top: global_BoxShadow_sm_top.var,
    md: global_BoxShadow_md.var,
    md_left: global_BoxShadow_md_left.var,
    md_right: global_BoxShadow_md_right.var,
    md_bottom: global_BoxShadow_md_bottom.var,
    md_top: global_BoxShadow_md_top.var,
    lg: global_BoxShadow_lg.var,
    lg_left: global_BoxShadow_lg_left.var,
    lg_right: global_BoxShadow_lg_right.var,
    lg_bottom: global_BoxShadow_lg_bottom.var,
    lg_top: global_BoxShadow_lg_top.var,
    inset: global_BoxShadow_inset.var
  }
};
...
export const StyledTheme = {
  ...
  radii: {
    sm: global_BorderRadius_sm.var,
    lg: global_BorderRadius_lg.var
  },

  // 	Array of numbers to use as a typographic scale
  fontSizes: [
    global_FontSize_xs.var,
    global_FontSize_sm.var,
    global_FontSize_md.var,
    global_FontSize_lg.var,
    global_FontSize_xl.var,
    global_FontSize_2xl.var,
    global_FontSize_3xl.var,
    global_FontSize_4xl.var
  ],

  // Array of numbers for use as margin and pixel values
  space: [
    global_spacer_xs.var,
    global_spacer_sm.var,
    global_spacer_md.var,
    global_spacer_lg.var,
    global_spacer_xl.var,
    global_spacer_2xl.var,
    global_spacer_3xl.var
  ],

  // Color names that can be used in color, bg, and borderColor props
  colors: {
    bg_100: global_BackgroundColor_100.var,
    bg_200: global_BackgroundColor_200.var,
    bg_300: global_BackgroundColor_300.var,
    bg_light_100: global_BackgroundColor_light_100.var,
    bg_light_200: global_BackgroundColor_light_200.var,
    bg_light_300: global_BackgroundColor_light_300.var,
    bg_dark_100: global_BackgroundColor_dark_100.var,
    bg_dark_200: global_BackgroundColor_dark_200.var,
    bg_dark_transparent_100: global_BackgroundColor_dark_transparent_100.var,
    bg_dark_transparent_200: global_BackgroundColor_dark_transparent_200.var,
    color_100: global_Color_100.var,
    color_200: global_Color_200.var,
    light_100: global_Color_light_100.var,
    light_200: global_Color_light_200.var,
    dark_100: global_Color_dark_100.var,
    dark_200: global_Color_dark_200.var,
    active_100: global_active_color_100.var,
    active_200: global_active_color_200.var,
    active_300: global_active_color_300.var,
    disabled_100: global_disabled_color_100.var,
    disabled_200: global_disabled_color_200.var,
    primary_100: global_primary_color_100.var,
    primary_200: global_primary_color_200.var,
    primary_light_100: global_primary_color_light_100.var,
    primary_dark_100: global_primary_color_dark_100.var,
    secondary_100: global_secondary_color_100.var,
    success_100: global_success_color_100.var,
    success_200: global_success_color_200.var,
    info_100: global_info_color_100.var,
    info_200: global_info_color_200.var,
    warning_100: global_warning_color_100.var,
    warning_200: global_warning_color_200.var,
    danger_100: global_danger_color_100.var,
    danger_200: global_danger_color_200.var,
    danger_300: global_danger_color_300.var,
    link: global_link_Color.var,
    link_hover: global_link_Color_hover.var,
    link_light_hover: global_link_Color_light_hover.var,
    border: global_BorderColor.var,
    border_light: global_BorderColor_light.var,
    border_light_200: global_BorderColor_light_200.var,
    border_dark: global_BorderColor_dark.var
  },

  // Array or Object: Values for the fontFamily prop
  fonts: {
    sans_serif: global_FontFamily_sans_serif.var,
    monospace: global_FontFamily_monospace.var
  },

  // Array or Object: Values for fontWeight prop
  fontWeights: {
    light: global_FontWeight_light.var,
    normal: global_FontWeight_normal.var,
    semi_bold: global_FontWeight_semi_bold.var,
    bold: global_FontWeight_bold.var,
    link: global_link_FontWeight.var
  },

  // Array or Object: Values for lineHeight prop
  lineHeights: {
    sm: global_LineHeight_sm.var,
    md: global_LineHeight_md.var
  },

  // Array or Object: Values for border props
  borders: {
    sm: `${global_BorderWidth_sm.var} solid`,
    md: `${global_BorderWidth_md.var} solid`,
    lg: `${global_BorderWidth_lg.var} solid`
  },
  ...
  // Custom array
  zIndices: [
    global_ZIndex_xs.var,
    global_ZIndex_sm.var,
    global_ZIndex_md.var,
    global_ZIndex_lg.var,
    global_ZIndex_xl.var,
    global_ZIndex_2xl.var
  ]
};
