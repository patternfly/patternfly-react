...
export class Page extends React.Component<PageProps, PageState> {
  ...
  static defaultProps = {
    ...
    isDrawerPanelExpanded: false,
    isDrawerPanelInline: false,
  ...
  render() {
    ...
    const mainContentWithDrawer: React.ReactNode = (
      <Drawer panelContent={drawerPanelContent} isExpanded={isDrawerPanelExpanded} isInline={isDrawerPanelInline}>
        {mainContent}
      </Drawer>
    );
    ...
    return (
      <PageContextProvider value={context}>
        <div {...rest} className={css(styles.page, className)}>
          ...
          {header}
          {sidebar}
          {drawerPanelContent ? mainContentWithDrawer : mainContent}
        </div>
      </PageContextProvider>
    );
  }
