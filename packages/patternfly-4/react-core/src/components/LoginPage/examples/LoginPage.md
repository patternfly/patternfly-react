...
class SimpleLoginPage extends React.Component {
  ...
  render() {
    ...
    const socialMediaLoginContent = (
      <React.Fragment>
        <LoginMainFooterLinksItem href="#" aria-label="Login with Google">
        ...
        <LoginMainFooterLinksItem href="#" aria-label="Login with Github">
