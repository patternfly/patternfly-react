...
class InfoAlert extends React.Component {
  constructor(props) {
    ...
    this.hideAlertOne = () => this.setState({ alertOneVisible: false });
    this.hideAlertTwo = () => this.setState({ alertTwoVisible: false });
    this.variantText = "Custom screenreader text:";
  }
      ...
      <React.Fragment>
        {alertOneVisible && (
          <Alert
            ...
            title="Info alert title"
            action={<AlertActionCloseButton onClose={this.hideAlertOne} />}
            variantLabel={this.variantText}
          >
            These alerts use the custom text: {`"${this.variantText}"`} for the title for the screenreader.
          </Alert>
        )}
        {alertTwoVisible && (
          <Alert
        ...
        <Alert variant="info" variantLabel={this.variantText} title="Info alert title" action={<AlertActionLink>Action Button</AlertActionLink>} />
        <Alert variant="info" variantLabel={this.variantText} title="Info alert title" />
      </React.Fragment>
    );
  }
}
