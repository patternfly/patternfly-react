...
import '@patternfly/react-styles/css/components/Wizard/wizard';
            ...
            <div className="pf-c-wizard pf-m-in-page">
              ...
              >
                <ol className="pf-c-wizard__toggle-list">
                  ...
                  <li className="pf-c-wizard__toggle-list-item">Substep B</li>
                </ol>
                <i
              ...
              <div className="pf-c-wizard__outer-wrap">
                <div className="pf-c-wizard__inner-wrap">
                  <nav className="pf-c-wizard__nav">
                    <ol className="pf-c-wizard__nav-list">
                      <li className="pf-c-wizard__nav-item">
                        <h1 className="pf-c-title pf-m-md">Section One Title</h1>
                        <ol className="pf-c-wizard__nav-list">
                          <li className="pf-c-wizard__nav-item">Category Item One</li>
                          <li className="pf-c-wizard__nav-item">Category Item Two</li>
                          <li className="pf-c-wizard__nav-item">Category Item Three</li>
                        </ol>
                      </li>
                    </ol>
                    <ol className="pf-c-wizard__nav-list">
                      <li className="pf-c-wizard__nav-item">
                        <h1 className="pf-c-title pf-m-md">Section Two Title</h1>
                        <ol className="pf-c-wizard__nav-list">
                          <li className="pf-c-wizard__nav-item">Category Item One</li>
                          <li className="pf-c-wizard__nav-item">Category Item Two</li>
                          <li className="pf-c-wizard__nav-item">Category Item Three</li>
                  ...
                  <div className="pf-c-wizard__main">
                    ...
                    <PageSection>
                        <Gallery gutter="md">
                          <Card isHoverable isCompact>
                            ...
                            <CardBody>
                              PatternFly is a community project that promotes
                              design commonality and improves user experience.
                            </CardBody>
                          </Card>
                          <Card isHoverable isCompact>
                            <CardHead>
                            ...
                            <CardBody>
                              The ActiveMQ component allows messages to be sent
                              to a JMS Queue or Topic; or messages to be
                          ...
                          <Card isHoverable isCompact>
                            ...
                            <CardBody>
                              This documentation page covers the Apache Spark
                              component for the Apache Camel.
                            </CardBody>
                          </Card>
                          <Card isHoverable isCompact>
                            <CardHead>
                            ...
                            <CardBody>
                              This component provides a dataformat for avro,
                              which allows serialization and deserialization of
                              messages using Apache Avro’s binary dataformat.
                              Moreover, it provides support for Apache Avro’s
                              rpc, by providing producers and consumers endpoint
                              for using avro over netty or http.
                            </CardBody>
                          </Card>
                          <Card isHoverable isCompact>
                            <CardHead>
                            ...
                            <CardBody>
                              The Camel Components for Windows Azure Services
                          ...
                          <Card isHoverable isCompact>
                            ...
                            <CardBody>
                              For providing flexible endpoints to sign and
                              verify exchanges using the Signature Service of
                          ...
                          <Card isHoverable isCompact>
                            ...
                            <CardBody>
                              The dropbox: component allows you to treat Dropbox
                              remote folders as a producer or consumer of
                              messages.
                            </CardBody>
                          </Card>
                          <Card isHoverable isCompact>
                            ...
                            <CardBody>
                              Read or write to a fully-supported distributed
                              cache and data grid for faster integration
                              services.
                            </CardBody>
                          </Card>
                          <Card isHoverable isCompact>
                            ...
                            <CardBody>
                              The rest component allows to define REST endpoints
                              (consumer) using the Rest DSL and plugin to other
                              Camel components as the REST transport. From Camel
                              2.18 onwards the rest component can also be used
                              as a client (producer) to call REST services.
                            </CardBody>
                          </Card>
                          <Card isHoverable isCompact>
                            <CardHead>
                            ...
                            <CardBody>
                              Expose REST services and their APIs using Swagger
                              specification.
                            </CardBody>
                          </Card>
                        </Gallery>
