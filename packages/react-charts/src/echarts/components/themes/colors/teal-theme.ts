...
const COLOR_SCALE = [
  getComputedValue(chart_theme_teal_ColorScale_100),
  getComputedValue(chart_theme_teal_ColorScale_200),
  getComputedValue(chart_theme_teal_ColorScale_300),
  getComputedValue(chart_theme_teal_ColorScale_400),
  getComputedValue(chart_theme_teal_ColorScale_500)
];
