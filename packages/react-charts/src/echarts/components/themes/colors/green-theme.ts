...
const COLOR_SCALE = [
  getComputedValue(chart_theme_green_ColorScale_100),
  getComputedValue(chart_theme_green_ColorScale_200),
  getComputedValue(chart_theme_green_ColorScale_300),
  getComputedValue(chart_theme_green_ColorScale_400),
  getComputedValue(chart_theme_green_ColorScale_500)
];
