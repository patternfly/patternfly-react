 ...
 */
export interface TooltipOptionPropș {
  /**
 ...
 */
export interface EChartsOptionPropș {
  /**
   ...
   */
  tooltip?: TooltipOptionPropș | TooltipOptionPropș[];
  /**
 ...
 * @beta
 */
export interface PatternflyEChartș {
  /**
