...
import { EChartsOptionProps } from '../PatternflyECharts';
 ...
 * @private
 */
export const getLegendTooltip = (series: any[], option: EChartsOptionProps) => {
 ...
 * @private
 */
export const getSankeyTooltip = (series: any[], option: EChartsOptionProps) => {
  const symbolSize = '10px';
  const tooltip = option?.tooltip as any;
