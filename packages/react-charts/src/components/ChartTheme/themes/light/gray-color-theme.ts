...
const COLOR_SCALE = [
  chart_theme_gray_ColorScale_100.var2,
  chart_theme_gray_ColorScale_200.var2,
  chart_theme_gray_ColorScale_300.var2,
  chart_theme_gray_ColorScale_400.var2,
  chart_theme_gray_ColorScale_500.var2
];
