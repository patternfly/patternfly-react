...
const COLOR_SCALE = [
  chart_theme_green_ColorScale_100.var2,
  chart_theme_green_ColorScale_200.var2,
  chart_theme_green_ColorScale_300.var2,
  chart_theme_green_ColorScale_400.var2,
  chart_theme_green_ColorScale_500.var2
];
