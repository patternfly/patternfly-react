...
export const DonutThresholdDynamicTheme = {
  legend: {
    colorScale: [chart_donut_threshold_second_Color.var2, chart_donut_threshold_third_Color.var2]
  },
  pie: {
...
export const DonutThresholdStaticTheme = {
  pie: {
    colorScale: [
      chart_donut_threshold_first_Color.var2,
      chart_donut_threshold_second_Color.var2,
      chart_donut_threshold_third_Color.var2
    ],
