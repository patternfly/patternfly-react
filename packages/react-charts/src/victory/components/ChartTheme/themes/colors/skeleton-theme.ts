...
const COLOR_SCALE = [
  chart_skeleton_ColorScale_100.var,
  chart_skeleton_ColorScale_200.var,
  chart_skeleton_ColorScale_300.var,
  chart_skeleton_ColorScale_400.var,
  chart_skeleton_ColorScale_500.var
];
