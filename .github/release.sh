...
# yarn run lerna publish --conventional-commits --conventional-prerelease --create-release=github --no-verify-access --dist-tag=prerelease --yes 2>&1 | tee lerna-output.txt
